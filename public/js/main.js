...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Clouds; });
/* harmony import */ var _Entity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Entity */ "./js/Entity.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_Entity) {
  _inherits(Clouds, _Entity);

  function Clouds(config) {
    var _this;

    _classCallCheck(this, Clouds);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Clouds).call(this));
...
/* harmony import */ var _Clouds__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Clouds */ "./js/Clouds.js");
...
function () {
  function Game() {
    ...
    _defineProperty(this, "removeCloud", function (cloud) {
      var index = _this.clouds.indexOf(cloud);

      _this.clouds = [].concat(_toConsumableArray(_this.clouds.slice(0, index)), _toConsumableArray(_this.clouds.slice(index + 1)));
    });
  ...
  _createClass(Game, [{
    ...
    value: function addCloud() {
      this.clouds = [].concat(_toConsumableArray(this.clouds), [new _Clouds__WEBPACK_IMPORTED_MODULE_4__["default"](this.removeCloud)]);
    ...
    value: function loop() {
      ...
      var entities = [].concat(_toConsumableArray(this.birds), _toConsumableArray(this.bullets), _toConsumableArray(this.clouds), [this.hunter]);
